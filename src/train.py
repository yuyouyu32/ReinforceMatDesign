...
@click.option('--start_timesteps', default=1024, help='Timesteps to start training.')
...
def train(model, use_per, batch_size, episodes, save_path, start_timesteps, log_episodes, explore_base_index):
