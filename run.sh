...
nohup python -m train --model ddpg --batch_size 256 --episodes 2500 --save_path ../ckpts/ddpg_wo_per/ --start_timesteps 1024 --log_episodes 10 --explore_base_index 0 > ../logs/ddpg_wo_per_train.log 2>&1 &
